...
export const regis_close_soon_template = (
  receiver: Receiver,
        ...
        <div style="font-size: 14px; line-height: 20px; padding-top: 8px">
          <p style="margin: 12px 0px 0px 0px">
            <span style="color: #222 !important">
              The registration phase of 
              <a
                href="${tour_link}"
                target="_blank"
              >${tournament_name}</a> tournament 
              will be closed in less than 15 minutes, on ${close_time}. <br />
              If you have not registered yet, please visit our system so as not
              to miss any information.<br /><br/>
            </span>
          </p>
...
export const tournament_start_soon_template = (
  receiver: Receiver,
  tournament_name: string,
  start_time: string,
): string => {
    ...
    >
      ...
      <div class="heading" style="padding-top: 30px">
        ...
        <div style="font-size: 14px; line-height: 20px; padding-top: 8px">
          <p style="margin: 12px 0px 0px 0px">
            <span style="color: #222 !important">
              ${tournament_name} tournament will be started after 15 minutes, at
              ${start_time}. <br />
              Please visit our system so as not to miss any information.<br /><br/>
            </span>
          </p>
          <span style="color: #222">Best regards,</span><br />
          <span style="color: #222">Lucis Support Team</span><br /><br/>
...
export const subscriber_round_start_soon_template = (
  receiver: Receiver,
  round_name: string,
  tournament_name: string,
  start_time: string,
          ...
          <p style="margin: 12px 0px 0px 0px">
            <span style="color: #222 !important">
              ...
              <a
                ...
                target="_blank"
              >${tournament_name}</a> tournament
              will be started in less than 15 minutes, on ${start_time}. <br />
              Please visit our system so as not to miss any information.<br /><br />
            </span>
          </p>
          <span style="color: #222">Best regards,</span><br />
...
export const subscriber_round_started_template = (
  receiver: Receiver,
  round_name: string,
  tournament_name: string,
  tour_link: string,
...
export const tournament_closed_confirmed_template = (
  receiver: Receiver,
  tournament_name: string,
        ...
        <div style="font-size: 14px; line-height: 20px; padding-top: 8px">
          <p style="margin: 12px 0px 0px 0px">
            <span style="color: #222 !important">
              ...
              ${tournament_rank} <br/>
              Thank you for being interested!<br/><br/>
            </span>
          </p>
          <span style="color: #222">Best regards,</span><br />
          <span style="color: #222">Lucis Support Team</span><br /><br/>
